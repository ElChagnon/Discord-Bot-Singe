...
async def on_message(message):
    ...
    if message.author == Client.user:   
        return
    if message.content == "<@379315164815556631>":
        ...
        while x < 1:
            await message.channel.send("https://cdn.discordapp.com/attachments/883696103504105532/896741463407337572/istockphoto-1095019738-640_adpp_is.mp4")
            x=x+1
        else:
            return
